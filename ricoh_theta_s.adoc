= Unofficial API Guide - How to Use the THETA S API
:icons: font
:toc:
...
1. http://codetricity.github.io/theta-s/index.html[Unofficial API Usage] (This Guide)
2. http://theta360developers.github.io/community-document/community.html[Unofficial 360 Media Guide] Live Streaming of 360 videos, 360 image display.
