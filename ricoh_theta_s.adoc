= API Usage - Unoffical RICOH THETA S Community Guide (Guide 1 of 3)
:icons: font
:toc:
Craig Oda and the Community
...
- http://codetricity.github.io/theta-s/index.html[API Usage] (This Guide)
- http://theta360developers.github.io/community-document/community.html [360 Media]
Live Streaming of 360 videos, 360 image display.
- Usage - planned. Does not exist as of Dec, 2015
